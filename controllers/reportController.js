...
console.log("Loading reportController.js"); // للتشخيص

// Schema للتحقق من صحة بيانات التقرير
...
// جلب تقرير محدد - مسؤول أو مالك التقرير
const getReportById = async (req, res) => {
    try {
        const report = await Report.findById(req.params.id);
        if (!report) return res.status(404).json({ message: "Report not found" });
        
        // السماح فقط للمسؤول أو المالك برؤية التقرير
