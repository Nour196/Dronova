...
console.log("Loading orderController.js"); // للتشخيص
...
const createOrder = async (req, res) => {
    try {
        ...
        const { serviceType, location, scheduledDate, assignedDrone } = req.body;
        const newOrder = new Order({ 
            ...
            scheduledDate,
            assignedDrone,
            status: 'pending' // يتم تعيين الحالة مبدئيًا إلى "قيد المراجعة"
        });
...
// المسؤول يمكنه رؤية جميع الطلبات، الزبون يرى فقط طلباته
...
// المسؤول يمكنه رؤية أي طلب، الزبون يرى فقط طلباته
...
// الزبون يمكنه حذف الطلب قبل الموافقة فقط
